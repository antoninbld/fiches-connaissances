...
const db = {
  ...
  fiches: [
    {id: '1', catId: 'cat-a', title: 'Le service public', html: '<p>Administration</p>'},
    {id: '2', catId: 'cat-a', title: 'Énergie', html: '<p>Réseau électrique</p>'},
...
const getCortexSearchText = new Function('getCat', 'buildPath', 'normalizeCortexText', `${extractFunction('getCortexSearchText')}; return getCortexSearchText;`)(id => db.categories.find(cat => cat.id === id), fiche => fiche.catId, normalizeCortexText);
